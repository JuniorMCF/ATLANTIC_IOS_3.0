...
public class BubbleShowCase: UIView {
    ...
    */
    ...
    private var sideShowCaseLeading: NSLayoutConstraint?
    private var sideShowCaseTrailing: NSLayoutConstraint?
    ...
    */
    ...
    var position = 0
    var viewController2 : TutorialVC!
    public func show() {
        if !isInitialized {
            initialize()
        }
            ...
            viewController2 = storyboard.instantiateViewController(withIdentifier: "tutorialID") as! TutorialVC
            viewController2.bubbleCase = self
            viewController2.position = position
            print(position)
            viewController2.view.frame = CGRect(x:0, y: 35, width: viewController2.view.frame.width, height: 75)
            superview?.addSubview(viewController2.view)
            controller.tutorialController = viewController2
    ...
    private func takeScreenshot() {
        ...
        screenshotShadow.layer.cornerRadius = 10
        ...
        if shouldWhitenScreenshot {
            ...
            screenshotShadow.layer.cornerRadius = (barHeight + 16) / 2
        }
    ...
    private func constraintBubbleForTopDirections() {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            leading = NSLayoutConstraint(item: bubble, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: margins + extraMargins + CGFloat(marg2))
            bubbleLeading = leading
            centerX = NSLayoutConstraint(item: bubble, attribute: .centerX, relatedBy: .equal, toItem: self, attribute: .centerX, multiplier: 1, constant: -1.0 * CGFloat(marg))
        }
